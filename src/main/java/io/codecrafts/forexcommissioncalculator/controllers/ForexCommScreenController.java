...
public class ForexCommScreenController implements Initializable {
    ...
    private EventHandler<ActionEvent> eventHandler = (event) -> {
        ...
        if (spotPrice > 0) {
            ...
            this.audTotalCustomerLabel.setText(String.valueOf(totalAmountForCustomer));
            this.audTotalWholesaleLabel.setText(String.valueOf(totalAmountForWholesaler));
            this.difference.setText(String.valueOf(difference));
